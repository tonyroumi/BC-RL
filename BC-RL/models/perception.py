...
from models.resnet import resnet50d, resnet18d
...
class HybridEmbed(nn.Module):
    def __init__(
        ...
        if feature_size is None:
            ...
            feature_size = _ntuple(2)(feature_size)
...
class Fuser(nn.Module):
    def __init__(
        ...
        self.rgb_backbone = resnet50d(pretrained=True)
        self.lidar_backbone = resnet18d(pretrained=True)
        ...
        encoder_layer = TransformerEncoderLayer(
            embed_dim, num_heads, dim_feedforward, dropout, normalize_before
        )
